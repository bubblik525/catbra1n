...
export class Provider {
  ...
  async investigate(address) {
    ...
    return {
      ...
      checks: {
        verified: typeof code?.is_verified === 'boolean' ? code.is_verified : null,
        holders: token?.holders_count != null && Number.isFinite(Number(token.holders_count)) ? Number(token.holders_count) : null,
        listedShare: listed !== null && listed >= 0 && listed <= 100 ? listed : null,
        listedCount: Math.min(holders?.items?.length || 0, 10),
      },
      lines: [
